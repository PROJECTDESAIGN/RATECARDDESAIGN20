...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Biru Denim / Indigo Deep (#2B4C7E / #1E3A8A) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #2B4C7E}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#2B4C7E;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#2B4C7E;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#2B4C7E;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone denim light tint (#F0F4F8) */
    '.info-box{background:#F0F4F8;border:1px solid #C3D2E5;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Biru Denim (#2B4C7E) */
    '.paket-box{background:#2B4C7E;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#F8FAFC;border:1px solid #D1DCEC;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft denim (#E6EEF8) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#E6EEF8;border:1px solid #B0C4DE;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#18325A;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #C3D2E5;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
